      ...
      <div className="max-w-7xl mx-auto space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-white rounded-3xl p-8 flex flex-col justify-between space-y-6 border border-slate-200 shadow-xl">
            <div className="space-y-5">
              <div className="border-b border-slate-200 pb-4">
                <h3 className="text-2xl font-black text-slate-900 font-serif tracking-tight">{DEALERSHIP_INFO.name}</h3>
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl overflow-hidden border border-slate-200 shadow-xl relative min-h-[380px] flex flex-col">
            <div className="absolute top-4 left-4 z-20 bg-slate-900/90 text-white backdrop-blur-md border border-amber-500/40 px-3.5 py-2 rounded-xl text-xs font-black flex items-center gap-2 shadow-lg">
