      ...
      <div className="max-w-7xl mx-auto w-full relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-xs sm:text-sm text-slate-600 font-medium leading-relaxed max-w-2xl">
            Visit our multi-brand pre-owned hub opposite Hyundai Showroom in Kalaburagi. Managed by <strong className="text-slate-900 font-extrabold">Md Nawaz Khan</strong>. Every car undergoes a stringent 150-point technical check with guaranteed non-accidental status &amp; verified meter reading.
          </motion.p>
