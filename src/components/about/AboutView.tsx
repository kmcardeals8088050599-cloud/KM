          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-3xl p-5 border border-slate-200 shadow-md flex flex-col justify-between">
              ...
              <div>
                ...
                <p className="text-xs text-slate-600 mt-1 font-medium">Founder &amp; Chief Executive Director leading operations, client relations, and vehicle certification at KM Car Deals.</p>
              </div>
            </div>
