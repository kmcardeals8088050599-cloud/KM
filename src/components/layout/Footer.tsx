        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-slate-200">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-slate-600 leading-relaxed font-medium">
              Kalaburagi's premier multi-brand pre-owned car dealership. Managed by <strong className="text-slate-900 font-bold">Md Nadeem Khan</strong>. Every car undergoes a stringent 150-point technical check with non-accidental guarantee.
            </p>

            <div className="pt-2 flex items-center gap-2">
              <div className="flex items-center gap-1.5 bg-amber-50 px-3.5 py-1.5 rounded-xl text-xs font-bold text-amber-600 border border-amber-200">
          ...
          <div className="space-y-3">
            <h4 className="text-sm font-black text-slate-900 uppercase tracking-wider border-l-2 border-amber-500 pl-2.5">
              Quick Links
            </h4>
              ...
              {[
                ...
                <li key={link.path}>
                  <Link
                    ...
                    className="hover:text-amber-600 transition-colors flex items-center gap-1.5 text-slate-600 font-medium"
                  >
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-3 text-xs text-slate-600">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="font-bold text-slate-900">{DEALERSHIP_INFO.address}</p>
                  <p className="text-slate-500">{DEALERSHIP_INFO.city}, {DEALERSHIP_INFO.state} - {DEALERSHIP_INFO.pincode}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div className="space-y-0.5">
                  {DEALERSHIP_INFO.phones.map((p, idx) => (
                    <a key={idx} href={`tel:${p}`} className="block hover:text-amber-600 transition-colors font-bold text-slate-900">
                      {p}
                    </a>
                  ))}
                </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className="text-slate-600 font-medium">{DEALERSHIP_INFO.workingHours}</span>
              </div>
              ...
              <div className="pt-2">
                <a
                  ...
                  className="inline-flex items-center gap-1.5 text-amber-600 hover:text-amber-700 text-xs font-black transition-colors"
                >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500 font-medium">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-emerald-600 hover:text-emerald-700 transition-colors font-extrabold"
            >
